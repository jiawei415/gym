...
class AcrobotEnv(core.Env):
    ...
    **REFERENCE:**
    ...
    def __init__(self, link_len1=1., link_len2=1., link_mass1=1., link_mass2=1., **kwargs):
        self.viewer = None
        ...
        self.LINK_LENGTH_1 = link_len1  # [m]
        self.LINK_LENGTH_2 = link_len2  # [m]
        self.LINK_MASS_1 = link_mass1  #: [kg] mass of link 1
        self.LINK_MASS_2 = link_mass2  #: [kg] mass of link 2
        print('link_len1: {}, link_len2: {}, link_mass1: {}, link_mass2: {}'.format(
          link_len1, link_len2, link_mass1, link_mass2))
